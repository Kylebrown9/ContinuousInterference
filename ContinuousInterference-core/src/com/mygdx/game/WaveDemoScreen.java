...
public class WaveDemoScreen extends ScreenAdapter {

	public static final float VP_WIDTH = 800;
	public static final float VP_HEIGHT = 450;

	private static final float WAVES_WIDTH = VP_WIDTH / 2;
	private static final float WAVES_HEIGHT = VP_HEIGHT / 2;
	...
	public WaveDemoScreen(MyGame g) {
		game = g;
	...
	private Pixmap wavePix= new Pixmap((int) WAVES_WIDTH, (int) WAVES_HEIGHT, Format.RGBA8888);;
	...
	public void render(float delta) {
		...
		//wavePix = new Pixmap((int) WAVES_WIDTH, (int) WAVES_HEIGHT, Format.RGBA8888);
		...
		// camera.translate(delta*10, 0);
		// camera.rotate(delta*100, 0, 0, 1);
		camera.update();
		...
		shapeRenderer.rect(200, 200, 200, 200, Color.RED, Color.PURPLE, Color.PURPLE, Color.RED);
		shapeRenderer.rect(400, 200, 200, 200, Color.PURPLE, Color.BLUE, Color.BLUE, Color.PURPLE);
		shapeRenderer.end();
	}
